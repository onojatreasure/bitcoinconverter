...
public class ConverterSvcTest {
    ...
    @Test
    public void getExchangeRate_USD_ReturnsUSDExhangeRate() throws IOException{
        //arrange
    ...
    @Test
    public void convertBitcoins_0BitCoinToGBP_ReturnsZeroGBP() throws IOException {
        //arrange
        when(statusLine.getStatusCode()).thenReturn(200);
        when(response.getStatusLine()).thenReturn(statusLine);
        when(response.getEntity()).thenReturn(entity);
    ...
    @Test
    public void convertBitcoins_0BitCoinToEUR_ReturnsZeroEUR() throws IOException {
        //arrange
        when(statusLine.getStatusCode()).thenReturn(200);
        when(response.getStatusLine()).thenReturn(statusLine);
        when(response.getEntity()).thenReturn(entity);
